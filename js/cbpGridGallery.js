...
(function (window) {
	...
	CBPGridGallery.prototype._init = function () {
		// main grid
		this.grid = this.el.querySelector("main.grid-wrap > ul.grid");
		// main grid items
		...
		// slideshow grid
		this.slideshow = this.el.querySelector("main.slideshow > ul");
		...
		this.ctrlPrev = this.el.querySelector(
			"main.slideshow > nav > span.nav-prev"
		);
		this.ctrlNext = this.el.querySelector(
			"main.slideshow > nav > span.nav-next"
		);
		this.ctrlClose = this.el.querySelector(
			"main.slideshow > nav > span.nav-close"
		);
		// init masonry grid
		this._initMasonry();
		// init events
